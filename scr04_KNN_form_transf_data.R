...
#  nohup ./scr04_KNN_form_transf_data.R > ../logs/scr04_KNN_form_transf_data.log &
rm(list = ls())
library(tidyverse)
...
cat("\nLoading preds_full_data_KNN.rds\n")
timestamp()

pred_all = read_rds(paste0(path_predictions, "preds_full_data_",learner_id,".rds"))
