...
#  nohup ./scr02_XGB_base_models.R > ../logs/scr02_XGB_base_models.log &
...
path_models_full = paste0(path_proj, "models/base/full_data/XGB/")
dir.create(path_models_full, recursive = T)
path_models_split = paste0(path_proj, "models/base/split_data/XGB/")
dir.create(path_models_split, recursive = T)
path_predictions_train = paste0(path_proj, "predictions/base/split_data/XGB/train/")
dir.create(path_predictions_train, recursive = T)
path_predictions_test = paste0(path_proj, "predictions/base/split_data/XGB/test/")
