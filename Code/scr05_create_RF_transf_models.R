...
#  nohup ./scr05_create_RF_transf_models.R > ../logs/scr05_create_RF_transf_models.log &
...
path_datasets = paste0(path_proj, "datasets/transformed/RF/")
path_splits = paste0(path_proj, "data_splits/")
path_models_full = paste0(path_proj, "models/transformed/full_data/RF/")
dir.create(path_models_full, recursive = T)
path_models_split = paste0(path_proj, "models/transformed/split_data/RF/")
dir.create(path_models_split, recursive = T)
path_predictions_train = paste0(path_proj, "predictions/transformed/split_data/RF/train/")
dir.create(path_predictions_train, recursive = T)
path_predictions_test = paste0(path_proj, "predictions/transformed/split_data/RF/test/")
