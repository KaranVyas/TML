...
#  nohup ./scr02_SVM_base_models.R > ../logs/scr02_SVM_base_models.log &
...
path_models_full = paste0(path_proj, "models/base/full_data/SVM/")
dir.create(path_models_full, recursive = T)
path_models_split = paste0(path_proj, "models/base/split_data/SVM/")
dir.create(path_models_split, recursive = T)
path_predictions_train = paste0(path_proj, "predictions/base/split_data/SVM/train/")
dir.create(path_predictions_train, recursive = T)
path_predictions_test = paste0(path_proj, "predictions/base/split_data/SVM/test/")
